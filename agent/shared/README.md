...
This directory contains the shared LLM provider abstraction layer used by the quantum-verifier-agent.
...
The quantum-verifier-agent uses the providers like this:
...
# Test with the quantum-verifier agent
cd ..
npm start
```
